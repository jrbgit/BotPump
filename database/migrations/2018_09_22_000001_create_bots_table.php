...
class CreateBotsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->integer('completed_deals_usd_profit')->nullable()->default(null);
            $table->integer('active_deals_usd_profit')->nullable()->default(null);
            $table->integer('total_usd_profit')->nullable()->default(null);
