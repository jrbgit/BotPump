            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        <label for="long_bot_id" class="control-label">Long Bots</label>
                            <select class="form-control" class="required" id="long_bot_id" name="long_bot_id">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" class="required" id="short_bot_id" name="short_bot_id">
                        <option value="" disabled selected hidden>Choose One</option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" class="required" id="long_switch_action" name="long_switch_action">
                                <option value="" disabled selected hidden>Choose One</option>
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" class="required" id="short_switch_action" name="short_switch_action">
                                <option value="" disabled selected hidden>Choose One</option>
                                <option value="cancel">Cancel</option>
                                <option value="panic">Panic</option>
                                <option value="change_tp">Change TP</option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" class="required" id="first_long_deal" name="first_long_deal">
                                <option value="" disabled selected hidden>Choose One</option>
                                <option value="cancel">Enable</option>
                                <option value="panic">ASAP</option>
                                <option value="change_tp">ASAP & Enable</option>
                        </select>
                        @if ($errors->has('long_bot_id'))
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" class="required" id="first_short_deal" name="first_short_deal">
                                <option value="" disabled selected hidden>Choose One</option>
                                <option value="cancel">Enable</option>
                                <option value="panic">ASAP</option>
                                <option value="change_tp">ASAP & Enable</option>
