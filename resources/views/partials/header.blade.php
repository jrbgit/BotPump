<header class="main-header">
    ...
    <a href="{{ url('dashboard') }}" class="logo">
        ...
        <span class="logo-mini"><b>3</b>CM</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>3 COMMAS</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <ul class="sidebar-menu">
                            <li><a href="{{ url('apikey') }}"><i class="fa fa-key"></i>My APIs</a></li>
                            <li><a href="{{ url('plan') }}"><i class="fa fa-paper-plane"></i>My Plans</a></li>
